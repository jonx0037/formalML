...
connections:
  ...
  - topic: "statistical-depth"
    relationship: "T4 track closer. Depth and EVT are duals: EVT studies the outermost observations (block maxima, threshold exceedances), depth studies the innermost (the median, deep regions). They combine in multivariate EVT where shallow-depth observations identify candidate extremes and depth contours bound the central mass against which extremes are measured."
references:
  - type: "paper"
    title: "Limiting Forms of the Frequency Distribution of the Largest or Smallest Member of a Sample"
    authors: "Fisher & Tippett"
    year: 1928
    url: "https://doi.org/10.1017/S0305004100015681"
  ...
  - type: "paper"
    ...
    authors: "Mason"
    year: 1982
    url: "https://doi.org/10.1214/aop/1176993723"
...
import HillPlotExplorer from '../../components/viz/HillPlotExplorer';
...
<HillPlotExplorer client:visible />
