...
{/* TODO: <BlockMaximaVsPOT client:visible /> — viz embed deferred to step 6 (placed at the end of §4 to introduce the §5 POT contrast) */}
...
{/* TODO: <BlockMaximaVsPOT client:visible /> — viz embed deferred to step 6 (placed here to motivate the §5 vs §4 contrast directly after PBdH) */}
