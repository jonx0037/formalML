...
| [Shannon Entropy & Mutual Information](/topics/shannon-entropy) | Information Theory | The entropy and mutual information quantities are developed rigorously on the Information Theory track. KL divergence $D_{KL}(p \| q) = H(p,q) - H(p)$ is the divergence whose Hessian gives the Fisher metric. |
