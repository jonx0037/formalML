...
For more on message passing and its spectral interpretation, see **[Message Passing & GNNs](/topics/message-passing)**.
</TheoremBlock>
...
| **[Message Passing & GNNs](/topics/message-passing)** | Message passing is iterated Laplacian smoothing. On expanders, $O(\log n)$ layers suffice for global information flow but cause over-smoothing. The spectral gap quantifies this trade-off. |
