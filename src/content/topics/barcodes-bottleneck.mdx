...
- **[Sheaf Theory](/topics/sheaf-theory)**: sheaf-theoretic generalizations of persistence provide multi-parameter extensions where barcode decomposition no longer holds — the bottleneck distance generalizes to interleaving distance in this setting, and the Isometry Theorem shows why this generalization is natural.
