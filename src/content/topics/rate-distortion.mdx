...
references:
  ...
  - type: "book"
    ...
    authors: "Berger"
    year: 1971
    url: "https://doi.org/10.1016/C2009-0-22327-3"
...
- [Minimum Description Length](/topics/minimum-description-length) — MDL connects source coding (Shannon) to model selection: the best model minimizes description length = code length + model complexity.
