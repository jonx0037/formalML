...
| **Lagrangian Duality & KKT** *(coming soon)* | Conjugate functions are the engine of Lagrangian duality. The separation theorems lead to Farkas' lemma, which leads to the KKT conditions — the first-order optimality conditions for constrained convex optimization. |
