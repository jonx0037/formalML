...
| **Proximal Methods** *(coming soon)* | Subgradients motivate proximal operators — the proximal map of $f$ at $x$ minimizes $f(y) + \frac{1}{2}\|y - x\|^2$, a regularized subgradient step. |
