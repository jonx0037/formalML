...
<TheoremBlock type="proposition" number={4} title="Cross-Entropy Decomposition">
...
<TheoremBlock type="proposition" number={1} title="Non-negativity of KL (Gibbs' Inequality)">
...
<TheoremBlock type="proposition" number={2} title="KL Divergence and Equality">
...
<TheoremBlock type="proposition" number={3} title="Asymmetry of KL">
