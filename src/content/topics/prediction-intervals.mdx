...
formalstatisticsPrereqs:
  ...
  - topic: "empirical-processes"
    site: "formalstatistics"
    relationship: "The asymptotic alternative to finite-sample exchangeability arguments. Underlies the QR asymptotics cited in §3.3, Theorem 5.1's empirical-process stability argument for the conformal threshold, and Theorem 5.3's HL/conformal equivalence proof on location-shift models."
  - topic: "bootstrap"
    site: "formalstatistics"
    relationship: "The third resampling-based interval-construction method (alongside conformal and permutation-from-rank-tests). §7.1 of this topic contrasts bootstrap-percentile prediction intervals with the three featured constructions on resampling principle, coverage guarantee, computational cost, and validity scope."
...
For prediction intervals specifically, the bootstrap is rarely the right tool when conformal-style methods are available. We don't recommend it as a default, but we flag it because it's the construction practitioners most often use when they don't know the methods in this topic. The formal treatment of the bootstrap and its theoretical foundations is in <ExternalLink href="https://formalstatistics.com/topics/bootstrap" site="formalstatistics" topic="Bootstrap" />; a side-by-side empirical comparison with the three constructions in this topic is left as an exercise.

**What's deliberately out of scope.** Three areas the topic does not cover, with explicit pointers to where they belong.
...
**Forward connections within formalML.**
...
**Cross-site connections (formalstatistics).** The topic depends on four sister-site prerequisites; relationships are flagged in the frontmatter `formalstatisticsPrereqs`.

- <ExternalLink href="https://formalstatistics.com/topics/confidence-intervals-and-duality" site="formalstatistics" topic="Confidence Intervals & Duality" /> — The formal foundation for both HL-style test-inversion (§4) and the conformal $(1-\alpha)$-quantile threshold (§2.3). The duality between a level-$\alpha$ test and a $(1-\alpha)$ confidence region is the abstract machinery behind every interval construction in this topic.
- <ExternalLink href="https://formalstatistics.com/topics/order-statistics-and-quantiles" site="formalstatistics" topic="Order Statistics & Quantiles" /> — Split-conformal's quantile of conformity scores (Definition 7), QR's empirical conditional-quantile estimator (§3), and HL's Walsh-average ordering (§4) all rest on order-statistic theory. The asymptotic theory of empirical quantiles underlies the stability argument in Theorem 5.1 and the HL/conformal equivalence in Theorem 5.3.
- <ExternalLink href="https://formalstatistics.com/topics/empirical-processes" site="formalstatistics" topic="Empirical Processes" /> — The asymptotic alternative to finite-sample exchangeability arguments. The bootstrap discussion above leans on Edgeworth expansions, the QR asymptotics cited in §3.3 use empirical-process limit theorems, and Theorem 5.1's proof appeals to uniform stability of empirical-quantile order statistics.
- <ExternalLink href="https://formalstatistics.com/topics/bootstrap" site="formalstatistics" topic="Bootstrap" /> — Self-contained treatment of the bootstrap principle, percentile and BCa intervals, and the conditions under which bootstrap-percentile intervals are valid. This topic's bootstrap-as-contrast subsection is a tight summary; the full picture lives there.
