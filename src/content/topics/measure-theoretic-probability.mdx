...
| **PAC Learning Framework** *(coming soon)* | Probability & Statistics | Uses measure-theoretic probability to formalize learnability |
| **Bayesian Nonparametrics** *(coming soon)* | Probability & Statistics | Requires conditional expectation, Radon–Nikodym, and product measures for priors on infinite-dimensional spaces |
