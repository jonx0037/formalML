...
- **Geodesics & Curvature** *(coming soon)* — the differential (§7) tells us how maps curve, and the Riemannian metric (from the next topic) tells us how the manifold itself curves. Geodesics are the "straight lines" of curved spaces, and curvature quantifies how the manifold deviates from flatness.
