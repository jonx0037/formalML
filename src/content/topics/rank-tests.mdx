...
connections:
  ...
  - topic: "prediction-intervals"
    relationship: "T4's track closer generalizes §6 here from a Hodges-Lehmann *confidence interval* for a location parameter to an HL-style *prediction interval* for the next observation. The proof of Theorem 3 of prediction-intervals cites Theorem 10 here, and Theorem 5.3 (HL/conformal asymptotic equivalence) leans on the §5 Walsh-average asymptotic theory. The §6 batch comparison there documents HL's batch-coverage shortfall on shared calibration sets — a regime distinction worth carrying back to single-sample HL applications."
  - topic: "statistical-depth"
    relationship: "T4 track closer. Depth-induced multivariate ranks are the multivariate generalization of the empirical-CDF ordering used here. Hodges-Lehmann-style multivariate rank tests built on depth-induced ranks are distribution-free under elliptical symmetry and inherit the depth consistency theorem of statistical-depth §4.1 — the multivariate version of the §3 Wilcoxon null."
references:
  - type: "paper"
  ...
  - type: "book"
    ...
    authors: "Lehmann"
    year: 2006
    url: "https://doi.org/10.1007/0-387-37613-8"
