...
- **[The Mapper Algorithm](/topics/mapper-algorithm)**: The most widely-used applied TDA tool, built directly on the nerve construction introduced here — see the full construction and implementation
