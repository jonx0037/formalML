  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: isDesktop ? '1fr 1fr' : '1fr', gap: '8px' }}>
        <svg role="img" aria-label="Tail bound explorer visualization (panel 1 of 2)" ref={leftSvgRef} width={panelW} height={panelH} style={{
          border: '1px solid var(--color-border)', borderRadius: '6px', background: 'var(--color-muted-bg)',
        }} />
        <svg role="img" aria-label="Tail bound explorer visualization (panel 2 of 2)" ref={rightSvgRef} width={panelW} height={panelH} style={{
          border: '1px solid var(--color-border)', borderRadius: '6px', background: 'var(--color-muted-bg)',
        }} />
      </div>
