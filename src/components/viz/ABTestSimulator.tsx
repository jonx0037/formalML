...
function welchT(A: Float64Array, B: Float64Array): { t: number; df: number; p: number } {
  ...
  // Two-sided p via an approximation: |t| under t_df. For our purposes
  // (size studies at n_per_group ≥ 20), the normal approximation is plenty.
  // We use 2 * (1 - Φ(|t|)) for speed; this slightly overstates rejection
  // for very small df but doesn't materially change the displayed sizes.
